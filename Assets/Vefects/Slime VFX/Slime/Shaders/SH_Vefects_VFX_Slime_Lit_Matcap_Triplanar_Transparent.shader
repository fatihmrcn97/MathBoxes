...
Shader "Vefects/SH_Vefects_VFX_Slime_Lit_Matcap_Triplanar_Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 lerpResult84 = lerp( float4( float3(0,0,0) , 0.0 ) , ( float4( ase_vertex3Pos , 0.0 ) * saturate( ( ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_21_0).xy, 0, 0.0) ) * break31.z ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_21_0).yz, 0, 0.0) ) * break31.x ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_21_0).xz, 0, 0.0) ) * break31.y ) ) ) ) , _WPOIntensity);
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 desaturateInitialColor134 = tex2D( _Matcap, ((mul( UNITY_MATRIX_V, float4( normalizeResult104 , 0.0 ) ).xyz).xy*0.5 + 0.5) ).rgb;
			float desaturateDot134 = dot( desaturateInitialColor134, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar134 = lerp( desaturateInitialColor134, desaturateDot134.xxx, _MatcapDesaturate );
			float4 temp_output_136_0 = ( float4( desaturateVar134 , 0.0 ) * _MatcapTint );
			float3 hsvTorgb82 = RGBToHSV( temp_output_136_0.rgb );
			...
			float3 hsvTorgb85 = RGBToHSV( ( temp_output_136_0 + ( fresnelNode51 * _FrColor ) ).rgb );
			...
			float fresnelNode124 = ( _OpacityFrBias + _OpacityFrScale * pow( max( 1.0 - fresnelNdotV124 , 0.0001 ), _OpacityFrPower ) );
			float lerpResult127 = lerp( _OpacityMin , _OpacityMax , fresnelNode124);
			float op132 = saturate( ( saturate( lerpResult127 ) * _OpacityOverall ) );
			o.Alpha = op132;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-8064,-512;Inherit;False;Property;_OverallTilesMultiply;Overall Tiles Multiply;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;78;-8064,896;Inherit;False;Property;_NormalTile;Normal Tile;17;0;Create;True;0;0;0;False;0;False;1,1,1;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-5632,256;Inherit;False;Property;_NormalTriplanarContrast;Normal Triplanar Contrast;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;80;-7040,1024;Inherit;False;Property;_NormalTileSpeed;Normal Tile Speed;18;0;Create;True;0;0;0;False;0;False;0,1,1;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;106;-7552,896;Inherit;False;Property;_NormalTileOffsetCustom;Normal Tile Offset Custom;19;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TexturePropertyNode;113;-6528,0;Inherit;True;Property;_NormalTriplanarTexture;Normal Triplanar Texture;14;0;Create;True;0;0;0;False;3;Space(33);Header(Normal Triplanar);Space(13);False;45f10a9d5101da849979325375a62116;45f10a9d5101da849979325375a62116;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-4096,-896;Inherit;False;Property;_NormalIntensity;Normal Intensity;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;7;-8064,1920;Inherit;False;Property;_WPOTile;WPO Tile;23;0;Create;True;0;0;0;False;0;False;1,1,1;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-5504,1280;Inherit;False;Property;_WPOTriplanarContrast;WPO Triplanar Contrast;22;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;16;-7040,1664;Inherit;False;Property;_WPOTileSpeed;WPO Tile Speed;24;0;Create;True;0;0;0;False;0;False;0,1,1;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;17;-7552,1920;Inherit;False;Property;_WPOTileOffsetCustom;WPO Tile Offset Custom;25;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2816,896;Inherit;False;Property;_FrPower;Fr Power;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-2816,768;Inherit;False;Property;_FrScale;Fr Scale;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-2816,640;Inherit;False;Property;_FrBias;Fr Bias;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-2560,2176;Inherit;False;Property;_OpacityFrBias;Opacity Fr Bias;31;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;122;-2560,2432;Inherit;False;Property;_OpacityFrPower;Opacity Fr Power;30;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-2560,2304;Inherit;False;Property;_OpacityFrScale;Opacity Fr Scale;29;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;114;-2176,-512;Inherit;True;Property;_Matcap;Matcap;5;0;Create;True;0;0;0;False;3;Space(33);Header(Matcap);Space(13);False;-1;ff81ca010dd2fc2438848d4292297787;ff81ca010dd2fc2438848d4292297787;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;135;-1792,-384;Inherit;False;Property;_MatcapDesaturate;Matcap Desaturate;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;109;-2048,768;Inherit;False;Property;_FrColor;Fr Color;10;0;Create;True;0;0;0;False;3;Space(33);Header(Fresnel);Space(13);False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;124;-2176,2176;Inherit;False;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-2176,1920;Inherit;False;Property;_OpacityMin;Opacity Min;27;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;126;-2176,2048;Inherit;False;Property;_OpacityMax;Opacity Max;28;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DesaturateOpNode;134;-1792,-512;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;137;-1536,-384;Inherit;False;Property;_MatcapTint;Matcap Tint;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-1280,640;Inherit;False;Property;_HueShiftSpeed;Hue Shift Speed;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;127;-1792,1920;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;136;-1536,-512;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-1280,384;Inherit;False;Property;_HueShift;Hue Shift;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;128;-1536,1920;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;129;-1280,2048;Inherit;False;Property;_OpacityOverall;Opacity Overall;26;0;Create;True;0;0;0;False;3;Space(33);Header(Opacity);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;-1152,1920;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;131;-896,1920;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-640,1408;Inherit;False;Property;_WPOIntensity;WPO Intensity;21;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-640,1152;Inherit;False;Property;_EmissionMultiply;Emission Multiply;1;0;Create;True;0;0;0;False;3;Space(13);Header(General);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;115;464,-48;Inherit;False;1252;162.95;Ge Lush was here! <3;5;120;119;118;117;116;Ge Lush was here! <3;0.3782746,0.2798741,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;132;-640,1920;Inherit;False;op;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-640,384;Inherit;False;Property;_Smooth;Smooth;3;0;Create;True;0;0;0;False;0;False;0;0.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-640,256;Inherit;False;Property;_Specular;Specular;2;0;Create;True;0;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;768,0;Inherit;False;Property;_Src;Src;33;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;117;1024,0;Inherit;False;Property;_Dst;Dst;34;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;118;1280,0;Inherit;False;Property;_ZWrite;ZWrite;35;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;119;1536,0;Inherit;False;Property;_ZTest;ZTest;36;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;120;512,0;Inherit;False;Property;_Cull;Cull;32;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;133;-640,512;Inherit;False;132;op;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,0;Float;False;True;-1;5;ASEMaterialInspector;0;0;StandardSpecular;Vefects/SH_Vefects_VFX_Slime_Lit_Matcap_Triplanar_Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;True;_ZWrite;0;True;_ZTest;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;True;Transparent;;Transparent;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;True;_Src;10;True;_Dst;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;True;_Cull;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=5901F103E31D20E8712D257EB31895EEE0282D2C